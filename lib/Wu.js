/*!
 *  wu.js - v0.1.8
 *  build: Tue Apr 18 2017 12:04:09 GMT-0500 (CDT)
 *  web utils
 */
  ...
  _createClass(Wu, [{
    ...
    value: function getAttrs(dom, attrs) {
      ...
      this.each(['', 'data-'], function (v, k) {
        that.each(attrs || [], function (v2, k2) {
