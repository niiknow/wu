/*!
 *  wu.js - v0.2.6
 *  build: Mon May 08 2017 17:07:38 GMT-0500 (CDT)
 *  web utils
 */
...
function each(obj, iterator, context) {
  ...
  if (nativeForEach && obj.forEach === nativeForEach) {
    ...
    for (var j = 0, length2 = _keys.length; j < length2; j++) {
      if (iterator.call(context, obj[_keys[j]], _keys[j], obj) === breaker) return;
    }
  }
};
